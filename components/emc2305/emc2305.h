 ...
 *
 * Specific values of the enum constants are register values taken from the EMC2305 datasheet.
 */
...
/// This class includes support for the EMC2305 i2c fan controller.
/// The device has an output (PWM or DAC) and several sensors and this
/// class is for the EMC2305 configuration.
class Emc2305Component : public Component, public i2c::I2CDevice {
 public:
  ...
  Emc2305DACConversionRate dac_conversion_rate_;
};
