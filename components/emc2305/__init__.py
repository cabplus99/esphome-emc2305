...
CONVERSIONS_PER_SECOND = {
    ...
    "1/8":  Emc2305DACConversionRate.EMC2305_DAC_1_EVERY_8_S,
    "1/4":  Emc2305DACConversionRate.EMC2305_DAC_1_EVERY_4_S,
    "1/2":  Emc2305DACConversionRate.EMC2305_DAC_1_EVERY_2_S,
    "1":    Emc2305DACConversionRate.EMC2305_DAC_1_EVERY_SECOND,
    "2":    Emc2305DACConversionRate.EMC2305_DAC_2_EVERY_SECOND,
    "4":    Emc2305DACConversionRate.EMC2305_DAC_4_EVERY_SECOND,
    "8":    Emc2305DACConversionRate.EMC2305_DAC_8_EVERY_SECOND,
    "16":   Emc2305DACConversionRate.EMC2305_DAC_16_EVERY_SECOND,
    "32":   Emc2305DACConversionRate.EMC2305_DAC_32_EVERY_SECOND,
}

Emc2305Component = emc2305_ns.class_("Emc2305Component", cg.Component, i2c.I2CDevice)

EMC2305_COMPONENT_SCHEMA = cv.Schema(
    {
        cv.GenerateID(CONF_EMC2305_ID): cv.use_id(Emc2305Component),
    }
)
    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_PWM): cv.Schema(
                {
                    cv.Optional(CONF_RESOLUTION, default=8): cv.int_range(min=1, max=31),
